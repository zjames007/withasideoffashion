...
if (have_posts()):
	...
	if ($layout === 'sidebar_right' || $layout === 'sidebar_left')
	{
		...
		if (!$with_builder) $the_content = '<div class="post-content"' . $page_custom_width . '>' . uncode_get_row_template($the_content, $limit_width, $limit_content_width, $style, '', 'double', true, 'double') . '</div>';
