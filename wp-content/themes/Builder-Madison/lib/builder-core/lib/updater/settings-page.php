...
?>
	<div class="ithemes-updater-products" id="ithemes-updater-unrecognized">
		...
		<p><?php printf( __( 'Please check this page again at a later time to see if the problem resolves itself. If the product remains, please contact <a href="%s">iThemes support</a> and provide them with the details given below.', 'it-l10n-Builder-Madison' ), 'http://ithemes.com/support/' ); ?></p>
